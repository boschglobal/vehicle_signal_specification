...
| `instances_relation` | If `child` (default) is specified instances will be generated as children to this node. If `sibling` is specified they will be generated as siblings. See [instances](../instances)| _since version 6.1_ |
